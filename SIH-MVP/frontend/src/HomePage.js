    ...
    return (
        <div className="bg-gray-100 min-h-screen text-gray-800">
            ...
            <header className="flex flex-col items-center justify-center text-center p-16 md:p-24 bg-white shadow-md">
                <img src="/logoeklavyafinal.png" alt="Project Eklavya Logo" style={{ height: 400, width: 'auto' }} />
                <h1 className="text-5xl md:text-6xl font-extrabold text-gray-900">Project Eklavya</h1>
